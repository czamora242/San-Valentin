...
function iniciarApp() {
    ...
    async function guardarEnFirebase(datosReserva) {
        try {
            ...
            const docRef = await window.addDoc(
                window.collection(window.db, 'planes_san_valentin'), 
                datosReserva
            );
    ...
    confirmBtn.addEventListener('click', async function() {
        ...
        if (selectedOption === 'cena') {
            ...
            console.log('Lugar ingresado:', lugar);
            ...
            console.log('Película ingresada:', pelicula);
        ...
        console.log('Datos preparados:', datosReserva);
    ...
    // Función para ver todos los planes guardados
    window.verTodosLosPlanesGuardados = async function() {
        try {
